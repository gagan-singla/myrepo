...
module.exports = function (options) {
    ...
    UploadHandler.prototype.initUrls = function (fileInfo, cb) {
        var baseUrl = (this.req.secure ? 'https:' : 'http:') + '//' + (options.hostname || this.req.get('Host'));
        //var baseUrl = global.url;
	  /* if(this.req.get('Host').indexOf("auctionsoftwaremarketplace") >= 0)
	   {
		 var baseUrl = 'http://auctionsoftwaremarketplace.com:8003';  
	   }
	   else
	   {
		  //var baseUrl = 'https://bidforent.com'; // For live site
