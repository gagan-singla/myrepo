     ...
     <div class="row cmargin-row ">
      ...
      <div class="col-md-12  hide credit-drp">
        ...
        <div class="col-sm-6 padding-20">
          <input type="text" name="cardholder_name" data-braintree-name="cardholder_name" class="form-control col-md-4" value="" />
        </div>
         <div class="clear"></div>
        <div class="col-sm-3 padding-20">
          Credit Card Number
        ...
        <div class="col-sm-6 padding-20">
          <input type="text" name="number" data-braintree-name="number" class="form-control" value="" />
        </div>
         <div class="clear"></div>
        <div class="col-sm-3 padding-20">
          Expiry Date
        ...
        <div class="col-sm-2 padding-20">
          <input type="text" name="expiration_month" data-braintree-name="expiration_month" class="form-control col-md-3" value="" />
        </div>
     
        <div class="col-sm-2 padding-20">
          <input type="text" name="expiration_year" data-braintree-name="expiration_year" class="form-control col-md-3 " value="" />
        </div>
         <div class="clear"></div>
        <div class="col-sm-3 padding-20">
          CVV
        ...
        <div class="col-sm-2 padding-20">
          <input type="text" name="cvv" data-braintree-name="cvv" class="form-control col-md-3" value=""/>
