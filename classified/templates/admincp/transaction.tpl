...
<div class="container-fluid">
                ...
                <div class="row m-top-20">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="buynow"  {if $search.status == 'buynow'} selected {/if}>Buy Now</option>
                 ...
                 <div class="row">
                  ...
                  <div class="col-md-6" style="margin-bottom:2%; margin-top:2%;"><a href="{$config.url}{$dlink}" class="text-blue">Download Report</a></div>
                 </div>
                {include file="/admincp/transaction-list.tpl" nocache}

                  <a href="/admincp/transaction/download?{$fquery}" class="btn btn-success btn-right" style="margin-bottom:2%;"> Download Report </a>
                <!-- /.row -->
</div>
