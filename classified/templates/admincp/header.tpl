            ...
            {if $loged.admin}
                <ul class="nav navbar-nav side-nav">
                  ...
                  <li class="{$menu.shippingmenu}">
                    ...
                    <li class="{$menu.reportsmenu}">
                        <a href="javascript:;" data-toggle="collapse" data-target="#management"> <i class="fa fa-fw fa-edit"></i>  Management</a>
                        
                        <ul id="management" class="collapse {if $menu.reportsmenu} in {/if}"  aria-expanded="true" style="  font-size: 12px;">
                         <li class="{$menu.reportsmenu}"><a href="{$config.url}/admincp/reports/" > <i class="fa fa-fw fa-edit"></i> Report Management</a> </li>
                          ...
                          <li class="{$menu.emailtemplatemenu}"><a href="{$config.url}/admincp/emailtemplate/" > <i class="fa fa-fw fa-edit"></i> Email Management</a> </li>
