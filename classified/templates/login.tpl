      ...
      <form action="{$config['url']}/login/save" method="post" enctype="multipart/form-data" data-parsley-validate>
        ...
        <div class="login_form">
          <div class="log_fields">
            ...
            <input type="text" id="username" name="username" value="{$cookieemail}" placeholder="Enter Email Id"  class="form-control" required>
          </div>
          <span class="red fl"></span>
          <div class="log_fields">
            <p>Password <span class="red">*</span>:</p>
            <input type="password" id="password" name="password" value="{$cookiepassword}" placeholder="Password" class="form-control" required>
          </div>
        </div>
        <span class="red fl"></span>
