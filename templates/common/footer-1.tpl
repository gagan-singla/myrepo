    ...
    <div class="modal-dialog">
        <div class="modal-content" style="min-height:208px;padding-bottom:10px;">
            <div class="modal-header" style="text-align: center;">
                ...
                <h4 class="modal-title" id="myModalLabel1"><b> Dispute Details </b></h4>
            </div>
            <div class="modal-body">


                <div class="col-md-12">
                    <label class="col-md-2" style="padding-left:0" >Subject</label>
        ...
        <div class="row">
            ...
            <div class="col-md-offset-1 col-xs-12 col-sm-12 col-md-6">
                ...
                <div class="footer_right">
                    ...
                    <div><a href="{$config.url}/blog">Blog</a></div>
                    <div style="border-right: 1px solid #fff;"><a href="{$config.url}/how_it">How It Works</a></div>
                    <div><a href="{$config.url}/about/contacts">Contact Us</a></div>
                    <div><a href="{$config.url}/privacy">Privacy Policy</a></div>
                    <div><a href="{$config.url}/terms">Terms & Conditions</a></div>
                    <!--  {if $loged.userid > 0}
                ...
                <form action="{$config['url']}/login/save" method="post" data-parsley-validate
                    ...
                    <div class="agree_terms">
                        <div class="login_check wid100">
                            ...
                            <label><a href="{$config['url']}/login/forgot_password" title="Forgot password">Forgot
                                password?</a></label>
                        </div>
                    </div>
        ...
        <div class="modal-content phone-content">
            ...
            <div class="modal-body">
                <form action="javascript:void(0);" id="phone_popup_form" method="POST" data-parsley-validate
                    ...
                    <div class="row">
                        <div class="col-md-12 m-top-10">Phone Number (please enter with country code eg:+5555555555)
                        </div>
