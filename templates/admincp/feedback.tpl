        ...
        <table id="feedbacklist" class="table table-bordered table-hover fd4">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="fd3" > <a href="{$config.url}/product/view/{$val.pid}/{$val.ptitleurl}">View</a> |  <a href="javascript:void(0);" onclick="PopupBox2('{$config.url}/admincp/feedbacknew/delete/{$val.id}');">Delete</a></td>
            </tr>
         {/foreach}
         {if $reviewcount ==0}
             <tr>
