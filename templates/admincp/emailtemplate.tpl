...
<div class="container-fluid"> 
 ...
 <div class="col-md-12 reports2 sear">Email Templates</div>
  ...
  <div class="pull-left">
  <a href="{$config.url}/admincp/addemailtemplate" class="btn btn-success"> Add New Email Template</a>
  </div>
  ...
  <div class="pull-right padt1">
   ...
   <a href="{$config.url}/admincp/templateimport?temptype=email" style="margin-bottom:10px" class="btn btn-success pull-right">Import</a>
