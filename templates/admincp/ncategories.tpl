...
<div class="container-fluid"> 
  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        <li class="active"> <i class="fa fa-sitemap"></i>  <i class="fa fa-hand-o-right"></i> <i class="fa fa-edit"></i> {if $categories.id == 0 or $categories.id == ''} Add {else} Edit {/if} Category <i class="fa fa-hand-o-right"></i> {$projects.title} </li>
      </ol>
    </div>
  </div>
  <!-- /.row -->
