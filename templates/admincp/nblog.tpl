...
<div class="container-fluid"> 
  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        <li class="active"> <i class="fa fa-laptop"></i>{if $projects.id == 0 or $projects.id == ''} Add {else} Edit {/if} Blog <i class="fa fa-hand-o-right"></i> <i class="fa fa-edit"></i> <i class="fa fa-hand-o-right"></i> {$projects.title} </li>
      </ol>
    </div>
  </div>
  <!-- /.row -->
